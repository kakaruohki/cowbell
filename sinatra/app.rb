...
post '/callback' do
  ...
  if item_url.include?("qoo10")
    begin
      ...
      Items.create(site_name: detail_hash["site_name"], item_url: detail_hash["item_url"], item_name: detail_hash["item_name"], reference_price: detail_hash["reference_price"], normal_price: detail_hash["normal_price"], sale_price: detail_hash["sale_price"], affiliate_url: detail_hash["affiliate_url"], item_code: item_code, selling_price: detail_hash["selling_price"], item_url: detail_hash["item_url"], user_id: user_id, status: 0)
